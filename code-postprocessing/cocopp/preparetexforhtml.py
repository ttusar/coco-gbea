...
def main(latex_commands_for_html):
    ...
    for scenario in testbedsettings.all_scenarios:
        ...
        if scenario == testbedsettings.scenario_rlbased:
            ...
            genericsettings.runlength_based_targets = False
            config.config(testbedsettings.suite_name_tt)
        elif scenario == testbedsettings.scenario_ttbifixed:
            genericsettings.runlength_based_targets = False
            config.config(testbedsettings.suite_name_tt_bi)
        elif scenario == testbedsettings.scenario_mgfixed:
            genericsettings.runlength_based_targets = False
            config.config(testbedsettings.suite_name_mg)
        elif scenario == testbedsettings.scenario_mgbifixed:
            genericsettings.runlength_based_targets = False
            config.config(testbedsettings.suite_name_mg_bi)
        else:
